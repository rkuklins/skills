...
help:
	...
	@echo "  make deploy               Copy skills to ~/.sync-skills/skills, assistant dirs, and Google Drive"
	@echo "  make deploy-dry-run       Preview deploy without writing files"
	@echo "  make deploy-common-only   Copy only to ~/.sync-skills/skills (skips Google Drive)"
	@echo ""
